...
-- Запустить в новом запросе
INSERT INTO Card (numMK, dateMK, id_municip, adressTrapping, numWorkOrder, locality, dateWorkOrder, dateTrapping, targetOrder, typeOrder, firstNameExecuter, surNameExecuter, patronymicExecuter, phoneNumberExecuter, typeApplicant, firstNameAppl, surNameAppl, patronymicAppl, adressAppl, phoneNumberAppl, id_org, accessRoles, id_animal)
VALUES
