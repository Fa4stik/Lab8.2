...
VALUES
(23123, '13.05.2018', 1, 1, 'adressTrapping1', 23, 'locality1', '20.05.2018', '21.09.2012', 'targetOrder1', 'План-график', 1, '{"Оператор по отлову", "Куратор ВетСлужбы", "Куратор ОМСУ", "Подписант ОМСУ"}', 1),
(35121, '03.11.2020', 2, 2, 'adressTrapping2', 32, 'locality2', '27.11.2020', '22.01.2022', 'targetOrder2', 'План-график',  2, '{"Оператор по отлову","Куратор ВетСлужбы", "Подписант по отлову"}', 2),
(31989, '05.01.2021', 2, 2, 'adressTrapping3', 33, 'locality3', '11.01.2020', '25.11.2017', 'targetOrder3', 'План-график',  1, '{"Оператор по отлову","Подписант ВетСлужбы", "Оператор ОМСУ"}', 3),
(54898, '19.03.2021', 1, 1, 'adressTrapping4', 42, 'locality4', '15.02.2021', '26.06.2016', 'targetOrder4', 'Заказ-наряд',  1, '{"Оператор по отлову","Куратор ВетСлужбы", "Подписант по отлову"}', 4),
(19937, '09.02.2022', 2, 1, 'adressTrapping5', 35, 'locality5', '16.04.2021', '19.02.2020', 'targetOrder5', 'План-график',  2, '{"Оператор по отлову","Подписант по отлову", "Куратор ОМСУ"}', 5),
(65252, '28.04.2022', 2, 2, 'adressTrapping6', 92, 'locality6', '05.03.2022', '20.01.2021', 'targetOrder6', 'План-график',  2, '{"Оператор по отлову","Куратор по отлову", "Оператор ВетСлужбы"}', 6);